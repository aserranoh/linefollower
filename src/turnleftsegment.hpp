...
#ifndef TURNLEFTSEGMENT_HPP
#define TURNLEFTSEGMENT_HPP

#include "turnsegment.hpp"

class TurnLeftSegment: public TurnSegment {

    public:

        TurnLeftSegment(const glm::vec3& position, float orientation,
            int input);
        virtual ~TurnLeftSegment();
