...
#ifndef ACROSSROADSEGMENT_HPP
#define ACROSSROADSEGMENT_HPP

#include "squaresegment.hpp"

class ACrossroadSegment: public SquareSegment {

    public:

        ACrossroadSegment(const glm::vec3& position, float orientation,
            int input);
        virtual ~ACrossroadSegment();
